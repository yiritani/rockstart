...
const (
	InstrumentService_GetInstruments_FullMethodName = "/proto.v1.instrument.InstrumentService/GetInstruments"
)
...
type InstrumentServiceClient interface {
	GetInstruments(ctx context.Context, in *GetInstrumentsRequest, opts ...grpc.CallOption) (*GetInstrumentsResponse, error)
}
...
func (c *instrumentServiceClient) GetInstruments(ctx context.Context, in *GetInstrumentsRequest, opts ...grpc.CallOption) (*GetInstrumentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetInstrumentsResponse)
	err := c.cc.Invoke(ctx, InstrumentService_GetInstruments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InstrumentServiceServer interface {
	GetInstruments(context.Context, *GetInstrumentsRequest) (*GetInstrumentsResponse, error)
...
func (UnimplementedInstrumentServiceServer) GetInstruments(context.Context, *GetInstrumentsRequest) (*GetInstrumentsResponse, error) {
...
func _InstrumentService_GetInstruments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetInstrumentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InstrumentServiceServer).GetInstruments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InstrumentService_GetInstruments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InstrumentServiceServer).GetInstruments(ctx, req.(*GetInstrumentsRequest))
	}
...
var InstrumentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.v1.instrument.InstrumentService",
	HandlerType: (*InstrumentServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetInstruments",
			Handler:    _InstrumentService_GetInstruments_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/v1/instrument.proto",
}
