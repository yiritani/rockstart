...
const (
	...
	PingServiceName = "proto.v1.ping.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/proto.v1.ping.PingService/Ping"
)

// PingServiceClient is a client for the proto.v1.ping.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the proto.v1.ping.PingService service. By default,
...
func NewPingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PingServiceClient {
	...
	pingServiceMethods := v1.File_proto_v1_ping_proto.Services().ByName("PingService").Methods()
...
// Ping calls proto.v1.ping.PingService.Ping.
...
// PingServiceHandler is an implementation of the proto.v1.ping.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.v1.ping.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.v1.ping.PingService.Ping is not implemented"))
}
